		...
		<div id="container">
				...
				<c:if test="${normal!=null}">
					<c:forEach items="${normal}" var="normali" varStatus="normals">
						<c:if test="${normali[0].message_id == userId}">
						<section class="tab" >
							<div class="see">
								<div class="s-head">
								<img src="${pageContext.servletContext.contextPath}/userHead/${receive[normals.index][0].phone}/${receive[normals.index][0].head}"  width="100px" height="100px" /></div>
								<div class="s-mid">
									<div class="s-mid1">
										${receive[normals.index][0].nickname} &nbsp;&nbsp;
										<i class="fa fa-paw" style="color: gold;"></i>&nbsp;
										<i class="fa fa-ge"></i>&nbsp;
										<i class="fa fa-first-order" style="color: #2E3B84;"></i>
						
									</div>
									<div class="s-mid2">这里存了你们所有的聊天信息哦，快来查看吧</div>
								</div>
								<div class="s-bott" >
									<button type="button" onclick="location.href='${pageContext.servletContext.contextPath}/MessageServlet_enterAllMessage.do?listIndex=${normals.index}'">
										<i class="fa fa-commenting">&nbsp;</i>查看详情
									</button>
								</div>
							</div>
						</section>
						...
						<section class="tab" >
							<div class="see">
								<div class="s-head">
								<img src="${pageContext.servletContext.contextPath}/userHead/${send[normals.index][0].phone}/${send[normals.index][0].head}"  width="100px" height="100px" /></div>
								<div class="s-mid">
									<div class="s-mid1">
										${send[normals.index][0].nickname} &nbsp;&nbsp;
										<i class="fa fa-paw" style="color: gold;"></i>&nbsp;
										<i class="fa fa-ge"></i>&nbsp;
										<i class="fa fa-first-order" style="color: #2E3B84;"></i>
