			...
			<c:forEach items="${as}" var="i" varStatus="d">
				<div class="see">
					...
					<div class="s-mid">
						...
						<div class="s-mid3">${aa[d.index].browsedate}</div>
					</div>
					<div class="s-bott">
						...
						<button type="button" onclick="location.href='${pageContext.servletContext.contextPath}/FirstServlet_canfocusAttention.do?id=${i.userid}'"><i class="fa fa-heart">&nbsp;</i>取消关注</button>
		...
		<script>
			window.onload = function() {
				...
				<div class="r1">
					...
					<div class="r5">
						<div class="r5-1"><a href="#">我的关注</a></div>
