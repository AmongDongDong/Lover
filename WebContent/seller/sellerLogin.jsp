...
<link rel="stylesheet"
	href="${pageContext.servletContext.contextPath}/css/sellerLogin.css" />
<link rel="stylesheet"
	href="${pageContext.servletContext.contextPath}/font-awesome-4.7.0/css/font-awesome.min.css" />
<link rel="stylesheet" type="text/css"
	href="${pageContext.servletContext.contextPath}/bootstrapweb/bootstrap/css/bootstrap.min.css" />
<link rel="stylesheet"
...
<body>
	...
	<div class="base">
		<div class="one">
			...
			<form id="form" action="${pageContext.servletContext.contextPath}/SellerServlet_LoginCheck.do" method="post">
					<div class="in1">
						用户名:<input type="text" name="name" id="name" /><p><%=request.getAttribute("errMsg") == null? "" : request.getAttribute("errMsg")%></p>
					</div>
					<div class="in1">
						密&nbsp;&nbsp;&nbsp;&nbsp;码:<input type="password" name="password" id="password" /><p></p>
						<span></span>
					</div>
					<div class="in1">
					...
					<div class="in1">
						<a href="#">忘记密码</a>
						<a href="${pageContext.servletContext.contextPath}/SellerServlet_sellerLeague.do">注册账户</a>
					</div>
				</div>
		</div>
	</div>
